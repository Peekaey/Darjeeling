...
public interface IMappingHelper
{
    ...
    Task<List<GuildMemberDTO>> MapGuildUserToGuildMemberDTO(List<GuildUser> guildUsers);
    Task<GuildMemberNameHistoryDTO> MapGuildUserToGuildMemberNameHistoryDTO(FCGuildMember guildUser);
}